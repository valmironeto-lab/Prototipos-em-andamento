...
class Menu {
    ...
    public function setup_admin_menu() {
        ...
        if ( $this->page_exists( 'campaigns' ) ) {
            ...
            add_submenu_page( null, __( 'Nova Campanha', 'bluesendmail' ), __( 'Nova Campanha', 'bluesendmail' ), 'bsm_manage_campaigns', 'bluesendmail-new-campaign', array( $this->pages['campaigns'], 'render_add_edit_page' ) );
        }
        ...
        if ( $this->page_exists( 'contacts' ) ) {
            add_submenu_page( 'bluesendmail', __( 'Contactos', 'bluesendmail' ), __( 'Contactos', 'bluesendmail' ), 'bsm_manage_contacts', 'bluesendmail-contacts', array( $this->pages['contacts'], 'render' ) );
        }
