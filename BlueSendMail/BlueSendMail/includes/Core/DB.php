...
class DB {
    ...
    public static function on_activation() {
        ...
        // Adiciona as capabilities ao administrador
        ...
        // Garante que os cron jobs são agendados
