...
/**
 * **CORREÇÃO DEFINITIVA: Autoloader Auxiliar para Classes Legadas**
 * Registra um autoloader para carregar as classes WP_List_Table que não usam namespaces.
 * Isso é executado aqui para garantir que esteja disponível em todo o ciclo de vida do WordPress.
 */
...
register_deactivation_hook( BLUESENDMAIL_PLUGIN_FILE, __NAMESPACE__ . '\Core\Cron::deactivate' );
