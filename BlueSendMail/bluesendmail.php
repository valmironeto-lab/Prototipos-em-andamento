...
define( 'BLUESENDMAIL_VERSION', '2.2.1' );
...
// (O conteúdo destas funções permanece o mesmo)
...
// --- Carregamento Centralizado dos Arquivos do Plugin ---
final class BlueSendMail {
    ...
    /**
     * Carrega todos os arquivos necessários na ordem correta.
     */
    private function load_dependencies() {
        ...
        require_once BLUESENDMAIL_PLUGIN_DIR . 'includes/automations/abstracts/abstract-bsm-registry.php';
        require_once BLUESENDMAIL_PLUGIN_DIR . 'includes/automations/abstracts/abstract-bsm-trigger.php';
        require_once BLUESENDMAIL_PLUGIN_DIR . 'includes/automations/abstracts/abstract-bsm-action.php';
        
        // 2. Componentes de Automação
        require_once BLUESENDMAIL_PLUGIN_DIR . 'includes/automations/class-bsm-data-layer.php';
        require_once BLUESENDMAIL_PLUGIN_DIR . 'includes/automations/class-bsm-triggers-registry.php';
        require_once BLUESENDMAIL_PLUGIN_DIR . 'includes/automations/class-bsm-actions-registry.php';
        
        // 3. O Motor de Automação (agora que suas dependências estão carregadas)
	...
	private function instantiate_classes() {
        ...
        $this->automations = new BSM_Automations( $this ); // Agora pode ser instanciado com segurança
...
function bluesendmail_init() {
	return BlueSendMail::get_instance();
}
